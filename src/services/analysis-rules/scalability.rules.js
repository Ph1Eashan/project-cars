...
module.exports = [
  createRule({
    ...
    evaluate: (scanResult) => {
      ...
      return buildFailedRule({
        weight: 15,
        message: "Several synchronous operations were detected in code close to application logic.",
        issues: [buildIssue({
          category: "scalability",
          severity: "medium",
  ...
  createRule({
    ...
    evaluate: (scanResult) => {
      ...
      return buildFailedRule({
        weight: 15,
        message: `${internalDependencies.length} internal imports were found across a multi-service codebase.`,
        issues: [buildIssue({
          category: "scalability",
          severity: "medium",
